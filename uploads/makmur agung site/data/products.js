/* ============================================================
   MAKMUR AGUNG AUTOSHOP — Aozoom product catalog (data)
...
window.MA_PRODUCTS = {
  ...
  "categories": [
    { "id": "headlamp",        "label": "Headlamp Projector" },
    { "id": "square",          "label": "Square Headlamp" },
    { "id": "matrix",          "label": "Matrix Headlamp" },
    { "id": "premium",         "label": "Premium Laser" },
    { "id": "headlamp-kit",    "label": "Headlamp Kits" },
    { "id": "foglamp",         "label": "Foglamp Projector" },
    { "id": "foglamp-kit",     "label": "Foglamp Kits" },
    { "id": "mini",            "label": "Mini Projector" }
  ],
  "products": [
...

    {
      ...
      "tags": ["plug-and-play"],
      "waterproof": "IP54",
      "vehicles": ["Toyota Avanza 2023+", "Toyota Veloz 2023+"]
    },

    {
      ...
      "tags": ["plug-and-play"],
      "waterproof": "IP54",
      "vehicles": ["Toyota Innova Zenix 2023+"],
      "price_note": "Price shown from product page (Rp15,750,000). Summary table in catalog lists Rp19,750,000. Verify with supplier before quoting."
    },
