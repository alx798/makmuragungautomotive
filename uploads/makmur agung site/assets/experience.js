...
(function () {
  ...
  function initPreloader(done) {
    var el = $('#preloader');
    if (!el || prefersReduced || !hasGSAP) { hidePreloader(el); unlock(); done(); return; }
  ...
  /* ============================================================
     ...
     ============================================================ */
  var PRODUCTS = [
    { name: 'Megatron', cat: 'Premium Laser', type: 'Premium Laser Projector · 3"', temp: '5500K', low: 70, high: 90, price: 26000000, tag: 'LASER' },
    { name: 'Prime', cat: 'Premium Laser', type: 'Premium Laser Projector · 3"', temp: '5500K', low: 60, high: 85, price: 22000000, tag: 'LASER' },
    { name: 'Innova Zenix', cat: 'Plug & Play', type: 'Headlamp Plug & Play Kit · OEM Fit', temp: '6000K', low: 145, high: 171, price: 15750000, tag: 'PLUG & PLAY' },
    { name: 'Omega Laser', cat: 'Laser', type: 'Laser Projector Headlight · 3"', temp: '5500K', low: 70, high: 80, price: 7000000, tag: 'LASER' },
    { name: 'Leo', cat: 'Headlamp', type: 'Car LED Projector Headlight · 3"', temp: '5000K', low: 70, high: 78, price: 4975000, tag: 'BARU' },
    { name: 'Captain', cat: 'Matrix', type: 'Matrix LED Projector · 1.8"', temp: '5500K', low: 104, high: 136, price: 3700000, tag: '' },
    { name: 'White Wolf', cat: 'Headlamp', type: 'Car LED Projector Headlight · 2.5"', temp: '5000K', low: 96, high: 106, price: 3050000, tag: 'BARU' }
  ];
  ...
  function buildRail() {
    ...
    var html = PRODUCTS.map(function (p) {
      var badge = p.tag ? '<span class="pcard__badge">' + p.tag + '</span>' : '<span></span>';
      return '<article class="pcard" role="listitem">' +
        '<div class="pcard__top">' + badge + '<span class="pcard__cat">' + p.cat + '</span></div>' +
        '<div class="pcard__lens"><b></b></div>' +
        ...
        '<div class="pcard__foot">' +
          '<div class="pcard__price">' + rupiah(p.price) + '<small>Belum termasuk pasang</small></div>' +
